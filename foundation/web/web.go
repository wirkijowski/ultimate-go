...
func NewApp(shutdown chan os.Signal, mw ...Middleware) *App {
	...
	// Create an OpenTelemetry HTTP Handler which wraps our touter. This will start
...
// ServeHTTP implements the http.Handler interfaces. It's the entry point for
// all http traffic and allows the opentelemetry mux to run first to handle
// tracing. The opentelemetry mux then calls the apllication mux to handle
