...
import (
	...
	"github.com/wirkijowski/ultimate-go/business/data/tests"
...
func TestUser(t *testing.T) {
	...
	t.Log("Given the need to work with User records.")
	{
		...
		t.Logf("\tTest %d:\tWhen handling a single User.", testID)
		{
			...
			nu := user.NewUser{
				Name:            "Wojciech Wirkijowski",
				Email:           "wojciech@wirkijowski.pl",
			...
			upd := user.UpdateUser{
				...
				Email: tests.StringPointer("jacob@nowhere.com"),
			}
