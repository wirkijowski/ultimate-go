...
// KeyLookup decalares a method set of behavior for looking up
...
// ValidateToken recreate the Claims that were used to generate a token. It
// varifies the the token was signed using our key.
